...
<template>
  <div>
    ...
    <div
      class="grid grid-cols-8 gap-1 p-2 rounded-md bg-[color:var(--color-surface-elevated)] border max-h-44 overflow-y-auto"
    ...
    >
      <button
        ...
        class="w-8 h-8 flex items-center justify-center rounded transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-accent)]"
