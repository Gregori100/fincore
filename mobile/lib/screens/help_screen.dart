          ...
          const _FaqTile(
            ...
            body:
                ...
                '• Cashflow mensual: ingresos vs gastos por mes en el rango '
                  'seleccionado. Al tapear una fila de mes se abre el desglose '
                  'por categoría (ingresos y gastos) con acceso directo a los '
                  'movimientos del mes. Cada categoría muestra un chip vs el '
                  'mes anterior: ▲ sube o ▼ baja según si el cambio es mejor '
                  'o peor para tu bolsillo.\n'
