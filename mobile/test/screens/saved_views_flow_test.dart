...
void main() {
  group('Saved views flow', () {
    ...
    testWidgets(
      ...
      // El chip del filtro activo debe aparecer en la
      // `EntriesActiveFiltersBar` específicamente, no en cualquier otro
      // sitio. Atamos el find a esa bar para impedir falsos verdes.
      expect(
        find.descendant(
          of: find.byType(EntriesActiveFiltersBar),
          matching: find.text('Gasto'),
        ),
        findsOneWidget,
      );
    ...
    testWidgets(
      ...
      expect(
        find.text('No hay vistas guardadas todavía.'),
        findsOneWidget,
      );
